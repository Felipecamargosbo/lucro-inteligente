    ...
    <div className="mx-auto max-w-[1500px] space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <CardKpi
          ...
          detalhe={`Ticket médio: ${formatBRL(resumo.ticketMedio)}`}
        ...
        <CardKpi
          ...
          detalhe={`Média de ${formatBRL(projecao.mediaDiaria)} por dia em ${projecao.diasDecorridos} dias`}
        />
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3 xl:grid-cols-6">
        ...
        <CardKpi
          ...
          valor={formatNumero(resumo.pedidosCancelados)}
        />
        <CardKpi
              ...
              return (
                <div key={e.rotulo} className="flex items-center justify-between px-5 py-4">
                  ...
                  <div className="text-right">
                    ...
                    <p
                      className={`num text-[11px] font-bold ${v >= 0 ? "text-profit" : "text-loss"}`}
                    >
                      {v >= 0 ? "+" : "−"}
